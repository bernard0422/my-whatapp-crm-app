...
A WhatsApp-native micro-CRM that automates order-taking and customer Q&A for small businesses, with a paid subscription gate from day one.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "196927081+bernard0422@users.noreply.github.com"
  git config user.name "bernard0422"
  ```
